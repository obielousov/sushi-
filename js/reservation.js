...
//#endregion
//#region src/components/forms/datepicker/_lang.json
var import_datepicker_min = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		return function(e) {
			...
			function f(e, t, n) {
				...
				for (var M = 1; M <= S; M++) {
					...
					Y && !P && (A += " qs-event"), j && (A += " qs-outside-current-month"), !l && j || (A += " qs-num"), N && (A += " qs-active"), (c[+L] || t.disabler(L) || _ && t.noWeekends || s && +L < +s || o && +L > +o) && !P && (A += " qs-disabled"), +g(/* @__PURE__ */ new Date()) == +L && (A += " qs-current"), +L === m && y && I && (A += " qs-range-start"), +L > m && +L < y && (A += " qs-range-middle"), +L === y && m && I && (A += " qs-range-end"), P && (A += " qs-empty", k = ""), q.push("<div class=\"" + A + "\" data-direction=\"" + O + "\">" + k + "</div>");
				}
			...
			function E(e, t, n, a) {
				var r = isNaN(+(/* @__PURE__ */ new Date()).setFullYear(t.value || void 0)), i = r ? null : t.value;
						...
						if ("click" === n) {
							...
							if (s.noPosition && !l) (c.classList.contains("qs-hidden") ? S : q)(s);
								...
								if (o.contains("qs-num")) {
									...
									+x == +s.dateSelected ? m(r, s, !0) : r.classList.contains("qs-disabled") || m(r, s);
									return;
								}
			...
			t.default = function(e, t) {
				var n = function(e, t) {
					var n, l, d = function(e) {
						...
						if (t.startDate = g(t.startDate || d || /* @__PURE__ */ new Date()), t.disabledDates = (t.disabledDates || []).reduce((function(e, t) {
							var n = +g(t);
...
//#endregion
//#region src/components/forms/datepicker/datepicker.js
var datePickers = document.querySelectorAll("[data-fls-datepicker]");
if (datePickers.length) {
	const LANG = "ua";
	window.flsDatepicker = [];
	datePickers.forEach((datePicker) => {
		let datePickerItem = (0, import_datepicker_min.default)(datePicker, {
			customDays: _lang_default[LANG].week,
			customMonths: _lang_default[LANG].month,
			overlayButton: _lang_default[LANG].button,
			overlayPlaceholder: _lang_default[LANG].year,
			startDay: 1,
